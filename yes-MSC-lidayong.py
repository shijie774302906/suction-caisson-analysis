...
PARAM = dict(
    ...
    L   = 0.24,     # skirt length L1 (m)
    t   = 0.002,     # wall thickness t1 (m)

    # circular outer skirt
    R2  = 0.050,     # skirt‑width radius  (m)
    L2  = 0.030,     # skirt wall length   (m)
    t2  = 0.000,     # skirt wall thickness(m)
...
THETA = 0.06          # fixed rotation 1.5°
ECC   = 2.5                          # H eccentricity e = M/(H·D)
